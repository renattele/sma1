...
/**
 * Add the [content] [Composable] as bottom sheet content to the [androidx.navigation.NavGraphBuilder]
 *
...
/** DSL for constructing a new [androidx.navigation.compose.ComposeNavigator.Destination] */
@NavDestinationDsl
